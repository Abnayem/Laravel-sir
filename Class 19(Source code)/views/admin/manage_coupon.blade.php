             ...
             <label for="category_name" class="control-label mb-1">Title</label>
              <input id="title" name="title" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{$title}}" required>
               ...
               <div class="alert alert-danger">    
                ...
                <input id="code" name="code" type="text" class="form-control cc-name valid" value="{{$code}}" 
                ...
                <input id="value" name="value" type="text" class="form-control cc-name valid" value="{{$value}}" 
                 aria-required="true" aria-invalid="false" required>
                 @error('value')
                <div class="alert alert-danger">    
                {{$message}}
